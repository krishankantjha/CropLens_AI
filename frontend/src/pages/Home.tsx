            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
              <div className="rounded-[24px] border border-[#DDE4DE] bg-[#F8F7F2] p-6 sm:p-8">
                ...
                <div className="mt-10 grid grid-cols-3 gap-2">
                  <div>
                    <p className="data-mono text-xl font-extrabold text-[#66716A] sm:text-2xl">₹1,360</p>
                  ...
                  <div className="border-l border-[#DDE4DE] pl-3 sm:pl-5">
                    <p className="data-mono text-xl font-extrabold text-[#176B45] sm:text-2xl">₹1,480</p>
                    <p className="mt-2 text-[11px] font-bold uppercase tracking-[.12em] text-[#66716A]">Expected price</p>
                  </div>
                  <div className="border-l border-[#DDE4DE] pl-3 sm:pl-5">
                    <p className="data-mono text-xl font-extrabold text-[#0E4D35] sm:text-2xl">₹1,620</p>
