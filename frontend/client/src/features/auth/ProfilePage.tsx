...
export default function ProfilePage() {
  ...
  const loadProfile = useCallback(async () => {
    ...
    setError("");
    try {
      const profile = await getCurrentUser({ notifyUnauthorized: false });
